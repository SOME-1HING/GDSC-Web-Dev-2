...
const InputField = styled.input`
  ...
  opacity: 1;
`;
const SearchBox = ({ colorScheme }: { colorScheme: string }) => {
  return (
    <Container
      style={{ backgroundColor: `var(--${colorScheme}-searchBackground)` }}
    >
      <SearchIcon>
        <svg
          width="20"
        ...
        >
          <path
            ...
            stroke={`var(--${colorScheme}-searchText)`}
            stroke-width="2"
      ...
      <InputField
        ...
        style={{ color: `var(--${colorScheme}-searchText)` }}
      />
    </Container>
  );
};
